<?php
  ...
  if(isset($_POST["btn_username"])){
    $query = mysqli_query($con, "select admin_name from table_admin where admin_name = '".mres($con, $_POST['username'])."'") or die(mysqli_error($con));
    ...
    $query = mysqli_query($con, "select * from table_admin where admin_name = '".mres($con, $_POST['admin_name'])."' and password = '".md5(mres($con, $_POST['password']))."'") or die(mysqli_error($con));
    if(mysqli_num_rows($query) > 0){
...
<html lang="en">
  ...
  <body style="font-family: 'Comic sans MS'; font-size: 20px;">
    <div class="container">
      <div class="row">
          ...
          <div style="margin-top: 50px;" class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <div class="panel panel-info" style='display:<?php echo $form_username;?>'>
              ...
              <div class="panel-body">
                ...
                <form id="form_username" class="form-horizontal" role="form" method="post" action='<?php echo $_SERVER["PHP_SELF"]; ?>'>
            ...
            <div class="panel panel-info" style='display:<?php echo $form_password;?>'>
              ...
              <div class="panel-body">
                ...
                <form id="form_password" class="form-horizontal" role="form" method="post" action='<?php echo $_SERVER["PHP_SELF"]; ?>'>
