<?php
  ...
  if(isset($_POST['sign_up'])){
    ...
    $rand = rand(1, 3);
    if($rand == 1)
      $profil_pic = "head_read.jpg";
    else if($rand == 2)
      $profil_pic = "head_sun_flower.jpg";
    else if($rand == 3)
      $profil_pic = "head_turquoise.jpg";
    ...
    $insert = "INSERT INTO users (f_name, l_name, user_name, describe_user, Relationship, user_pass, user_email, user_country, user_gender, user_birthday, user_image, user_cover, user_reg_date, status, posts, recovery_account)
              VALUES ('$first_name', '$last_name', '$username', 'Hello WeShare. This is my default status!', '...', '$pass', '$email', '$country', '$gender', '$birthday', '$profil_pic', 'default_cover.jpg', NOW(), '$status', '$posts', 'Demo')";
